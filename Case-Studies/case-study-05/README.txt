...
* [game\application.properties](game/application.properties) &ndash; application.properties file generated by `grails create-app` *game*.
* The Grails application: http://localhost:8080/game.
