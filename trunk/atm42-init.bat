REM - Setting up environment AT-M42 Client Server Programming for the Java Platform
REM - for Groovy/Grails on Windows

@ECHO OFF
REM Edit the following lines to match your set up
SET JAVA_HOME=d:\java\jdk1.6.0_13
SET GROOVY_HOME=d:\java\languages\Groovy-1.6.2
SET GRAILS_HOME=d:\java\applications\grails-1.1
